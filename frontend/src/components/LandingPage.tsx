...
const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const technologies = [
    ...
    { name: 'Groq AI', icon: BrainCircuit, description: 'Textual Explanations' },
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-violet-50 to-purple-100 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              <span className="block text-gradient-purple">Tuberculosis Detection</span>
              <span className="block text-6xl">Tuberculosis Detection</span>
            </motion.h1>

            <motion.p
              className="text-xl md:text-2xl text-classic-text-light mb-8 max-w-3xl mx-auto leading-relaxed"
            >
              Tuberculosis detection and analysis.
        ...
        <div className="container mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-white/70 mb-4 flex items-center justify-center space-x-2">
              ...
              <span>for fighting Tuberculosis</span>
            </p>

            <p className="text-white/50 text-sm">
              AI Tuberculosis Detection System
            </p>
          </div>
        </div>
      </footer>
