    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-classic-text-light">
          Upload a bone imaging scan for AI-powered Tuberculosis detection
        </p>
      </div>
      ...
      >
        <div
          {...getRootProps()}
          className={`border-2 border-dashed  p-12 text-center cursor-pointer transition-all duration-300 ${isDragActive
